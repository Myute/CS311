...
{ 
 ...
 public:  // available to the client
  ...
  //          otherwise, throws an exception - Underflow
  // PARAMETER: provide the variable to receive the top element (by reference)
  void topElem(el_t&);

  // PURPOSE: check is the stack is empty
  ...
  // PURPOSE: displays all the contents of the stack
  void displayAll();

  // PURPOSE: clears all contents of the stack
  void clearIt();
