// CS311 - string use demo. 
// Note that = and == have been overloaded in the string class.
// Also note that the null char '\0' is found at the end and any blank in the string.
...
int main()
{
  ...
  if (S[4] == '\0') cout << "The entered word has 4 or less letters." << endl;
}
