...
//
// INSTRUCTIONS:
// Look for ** comments to complete this file
...
void BST::remove(Vertex *V, Vertex *P)
{
  ...
  if(!V->Right && !V->Left)
  {
	...
	P->Right=V->Left;
      // ** sholud point to V's left child; Make the left child
      // ** point up to Parent
      V->Left->Up=P;
      // ** Be sure to delete V
      delete V;
    ...
    else if(V->Right && !V->Left)// ** if V has just the right child so bypass V (case 2)
    {
